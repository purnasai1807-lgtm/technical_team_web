...
export default function App() {
  ...
  const [selectedEventIdForReg, setSelectedEventIdForReg] = useState<string>('wids-python-workshop-2026');
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <button onClick={() => { setActiveTab('home'); handleOpenRegister('wids-python-workshop-2026'); }} className="hover:text-cyan-300 transition-colors">
                    3-Day Python & Data Analytics Workshop
                  </button>
                </li>
                <li>
                  <button onClick={() => { setActiveTab('events'); }} className="hover:text-cyan-300 transition-colors">
                    Synapse AI & Web3 HackFest (36 Hours)
                  </button>
                </li>
                <li>
                  <button onClick={() => { setActiveTab('events'); }} className="hover:text-cyan-300 transition-colors">
                    Full-Stack & System Design Bootcamp
                  </button>
                </li>
                <li>
                  <button onClick={() => { setActiveTab('events'); }} className="hover:text-cyan-300 transition-colors">
                    WiDS Tech Leadership Seminar
                  </button>
                </li>
              </ul>
            </div>
